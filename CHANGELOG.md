...
- Inline follow-up controls on completed history cards for updating owner and review status without opening the detail page
- Insights dashboard section for the top five problems that should be handled this week, with direct links into the matching diagnosis records
