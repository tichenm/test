...
SMOKE_SCENARIOS = {
    ...
    "store-shrinkage-waste": {
        ...
        "storeName": "五角场店",
        "roleName": "门店店长",
        "expectedPainType": "shrinkage-spike",
        "answers": [
            "损耗偏高",
            "最近两周每周都会出现一次",
            "闭店复盘和周盘点前",
    ...
    "store-promo-execution": {
        ...
        "storeName": "浦东世纪汇店",
        "roleName": "门店店长",
        "expectedPainType": "promo-launch-delay",
        "answers": [
            "活动落地太慢",
            "每次活动切档基本都会出现一次",
            "活动切档前一晚和开档当天早班",
    ...
    "warehouse-picking-dispatch": {
        ...
        "storeName": "华东分拨中心",
        "roleName": "仓库主管",
        "expectedPainType": "picking-wave-delay",
        "answers": [
            "波次延迟",
            "每周高峰波次都会卡一两次",
            "首波次启动前和截单前",
